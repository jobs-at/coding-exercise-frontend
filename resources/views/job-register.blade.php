                            ...
                            <form class="form-horizontal" action="{{ route('job-store') }}" method="POST">
                                ...
                                <div class="row ">
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <div class="form-group mt-4 mb-4 p-0 m-0">
                                            ...
                                            <input class="form-control" type="datetime-local" required name="published_at" id="published_at" value="{{ old('published_at') }}">
                                        </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-6">
                                        ...
                                        <a class="btn btn-danger float-right" href="{{ route('jobs') }}">abort</a>
                                    </div>
                                </div>
                            </form>
                        </div>
